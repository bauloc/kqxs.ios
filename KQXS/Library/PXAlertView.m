		 ...
		 completion:(PXAlertViewCompletionBlock)completion
{
	...
	if (self) {
        ...
        //self.alertView.backgroundColor = [UIColor colorWithRed:255 green:0 blue:0 alpha:0.2];
		...
		self.titleLabel.font = [UIFont fontWithName:@"Souvenir" size:17.0];
		...
		self.messageLabel.font = [UIFont fontWithName:@"Souvenir" size:15.0];
...
- (UIButton *)genericButton
{
	...
	button.titleLabel.font = [UIFont fontWithName:@"Souvenir" size:15];
...
- (NSInteger)addButtonWithTitle:(NSString *)title
{
	...
	if (!self.cancelButton) {
		...
		lastButton.titleLabel.font = [UIFont fontWithName:@"Souvenir" size:15];
		...
		self.cancelButton.titleLabel.font = [UIFont fontWithName:@"Souvenir" size:15];
	}
